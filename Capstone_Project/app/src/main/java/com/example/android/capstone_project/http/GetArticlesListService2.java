...
public class GetArticlesListService2 extends IntentService {
    ...
    public GetArticlesListService2() {
        super("GetIngredientsListService");
    }

    public static void getTopArticles(Context context) {
        Intent intent = new Intent(context, GetArticlesListService2.class);
